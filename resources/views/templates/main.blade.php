...
<body>
  <div class="container-scroller">
    ...
    <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center">
        ...
        @endif
          ...
          <p class="font-weight-light small-text mb-0"> Stok {{ $notif->nama_barang }} tersisa
          {{ $notif->stok }}
          </p>
          </div>
          </a>
    ...
    @endphp
        ...
        <li class="nav-item">
        <a class="nav-link" data-toggle="collapse" href="#kelola_user" aria-expanded="false"
          aria-controls="kelola_user">
        ...
        <div class="collapse" id="kelola_user">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ url('/store') }}">Manage Store</a>
          </li>
          <li class="nav-item">
      ...
      @endif
          ...
          <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#erp" aria-expanded="false" aria-controls="erp">
                <span class="menu-title">ERP</span>
                <i class="menu-arrow"></i>
              </a>
              <div class="collapse" id="erp">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="{{ url('/erp/supplier') }}">Supplier</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{ url('/erp/erproduct') }}">Gudang Produksi</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{ url('/erp/purchase') }}">Purchase</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{ url('/erp/production') }}">Produksi</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{ url('/erp/masterproduct') }}">Master Gudang</a>
                  </li>
                </ul>
              </div>
            </li>
      ...
      <div class="main-panel">
        <div class="row">
          <div class="modal fade" id="notificationModal" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog">
              ...
              <p class="m-0 description-notification">Stok {{ $notif->nama_barang }} tersisa
              {{ $notif->stok }}
              </p>
              </div>
              </div>
        ...
        <footer class="footer" id="footer-content">
          <div class="container-fluid clearfix">
            <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright 2025 All rights
              reserved.</span>
