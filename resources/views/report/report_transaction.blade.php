        ...
        <div class="row">
          <div class="col-12 mb-2">
            ...
            <ul class="list-date">
              ...
              @php
              $transactions = \App\Models\Transaction::select('kode_transaksi','created_at')
              ...
              <div class="table-responsive">
                <table class="table table-custom">
                  ...
                  <tr>
                    @php
                    $transaksi = \App\Models\Transaction::where('kode_transaksi', $transaction->kode_transaksi)
                    ->select('transactions.*')
                    ->first();
                    $products = \App\Models\Transaction::where('kode_transaksi', $transaction->kode_transaksi)
                    ->select('transactions.*')
                    ->get();
                    $tgl_transaksi = \App\Models\Transaction::where('kode_transaksi', '=' , $transaction->kode_transaksi)
                    ->select('created_at')
                    ->first();
                    @endphp
                    <td class="td-1">
