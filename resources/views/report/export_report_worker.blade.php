...
<body>
	...
	<div class="header">
		<table class="w-100">
			...
			<tr>
				@php
				$pegawai = \App\Models\User::find($id);
				@endphp
	...
	<div class="body">
		...
		<ul>
			...
			@php
			$supplies = \App\Models\Supply::whereDate('supplies.created_at', $date)
			->where('id_pemasok', $id)
			->select('supplies.*')
			->latest()
			->get();
	...
	<div class="body">
		...
		<ul>
			...
			@php
			$transactions = \App\Models\Transaction::whereDate('transactions.created_at', $date)
			->where('id_kasir', $id)
			->select('transactions.*')
			->latest()
			->get();
				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							@php
							$jml_barang = \App\Models\Transaction::where('kode_transaksi', $transaction->kode_transaksi)
							->count();
							@endphp
