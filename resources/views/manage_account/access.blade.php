    ...
    <div class="card card-noborder b-radius">
      ...
      <div class="row">
        ...
        <table class="table table-custom">
          ...
          <tr>
            <th>Nama</th>
            <th class="text-center b-left">kelola user</th>
            ...
            <th class="text-center b-left">Status</th>
          </tr>
          </thead>
          <tbody>
          ...
          </td><td class="text-center b-left" data-access="kelola_user" data-user="{{ $user->user }}"
          data-role="{{ $user->role }}">
          @if($user->kelola_user == 1)
        ...
        @endif
          ...
          <td class="text-center b-left" data-access="kelola_akun" data-user="{{ $user->user }}"
          data-role="{{ $user->role }}">
        ...
        @endif
          ...
          <td class="text-center b-left" data-access="kelola_barang" data-user="{{ $user->user }}"
          data-role="{{ $user->role }}">
        ...
        @endif
          ...
          <td class="text-center b-left" data-access="transaksi" data-user="{{ $user->user }}"
          data-role="{{ $user->role }}">
          @if($user->transaksi == 1)
        <div class="btn-checkbox btn-access">
          <i class="mdi mdi-checkbox-marked"></i>
        ...
        @endif
          ...
          <td class="text-center b-left" data-access="kelola_laporan" data-user="{{ $user->user }}"
          data-role="{{ $user->role }}">
        ...
        <form action="{{ route('user.status.toggle', $user->id) }}" method="POST">
          @csrf
          @method('PUT')
          <button type="submit" class="btn btn-sm btn-success" title="Nonaktifkan Akun">
          Aktif
          </button>
        </form>
        @else
        <form action="{{ route('user.status.toggle', $user->id) }}" method="POST">
          @csrf
          @method('PUT')
          <button type="submit" class="btn btn-sm btn-danger" title="Aktifkan Akun">
          Nonaktif
          </button>
        </form>
        @endif
